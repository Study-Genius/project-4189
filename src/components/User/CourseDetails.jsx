...
const CourseDetails = () => {
  ...
  // Mock data with updated and verified YouTube links
  const courseData = {
    1: {
      ...
      videos: [
        "https://www.youtube.com/embed/Kp2bYWRQylk", // Algebra Basics
        "https://www.youtube.com/embed/WUvTyaaNkzM", // Geometry Basics
        "https://www.youtube.com/embed/Q4zHb-Swzro", // Arithmetic Basics
        "https://www.youtube.com/embed/3d6DsjIBzJ4"  // Problem Solving
      ],
      questions: [
        {
    ...
    2: {
      ...
      videos: [
        "https://www.youtube.com/embed/5nJg8FJxRtM", // Physics Basics
        "https://www.youtube.com/embed/FSyAehMdpyI", // Chemistry Basics
        "https://www.youtube.com/embed/hO3nH4A9Z5k", // Biology Basics
        "https://www.youtube.com/embed/3nAqYLk7q2E"  // Scientific Method
      ],
      questions: [
        {
    ...
    3: {
      ...
      videos: [
        "https://www.youtube.com/embed/wa-2-4FDzRg", // World Geography
        "https://www.youtube.com/embed/Pz5sTNGRVQE", // Maps and Globes
        "https://www.youtube.com/embed/7pR7FIz8vDk", // Climate and Weather
        "https://www.youtube.com/embed/5IpdjyD_uPo"  // Human Geography
      ],
      questions: [
        {
    ...
    4: {
      ...
      videos: [
        "https://www.youtube.com/embed/LXb3EKWsInQ", // Drawing Basics
        "https://www.youtube.com/embed/7Z-BYBeuEE4", // Color Theory
        "https://www.youtube.com/embed/1H1mUqoYl1k", // Painting Techniques
        "https://www.youtube.com/embed/3l5VJ9z0tY4"  // Art History
      ],
      questions: [
        {
    ...
    5: {
      ...
      videos: [
        "https://www.youtube.com/embed/C0DPdy98e4c", // Grammar Basics
        "https://www.youtube.com/embed/5V1xJY6aX6U", // Vocabulary Building
        "https://www.youtube.com/embed/8Qn_spdM5Zg", // Pronunciation Tips
        "https://www.youtube.com/embed/3qIuUY7Wlq4"  // Conversational English
      ],
      questions: [
        {
    ...
    6: {
      ...
      videos: [
        "https://www.youtube.com/embed/s5r18kdp_U4", // Computer Basics
        "https://www.youtube.com/embed/7UJZ5eb6i5A", // Software Basics
        "https://www.youtube.com/embed/3QhU9jd03a0", // Internet Basics
        "https://www.youtube.com/embed/8mAITcNt710"  // Cybersecurity Basics
      ],
      questions: [
        {
    ...
    7: {
      ...
      videos: [
        "https://www.youtube.com/embed/Yr2ZjNdP8r4", // Calculus Basics
        "https://www.youtube.com/embed/kjBOesZCoqc", // Linear Algebra
        "https://www.youtube.com/embed/TrcQbdz92Ko", // Trigonometry
        "https://www.youtube.com/embed/6kScLENCXLg"  // Advanced Problem Solving
      ],
      questions: [
        {
